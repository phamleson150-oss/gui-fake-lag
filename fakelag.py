...
class KeybindsWidget(QWidget):
    def __init__(self, on_close_callback, parent=None):
        ...
        self.tab_stack.addWidget(self.info_page)
        self.tab_stack.addWidget(self.feedback_page)
        self.tab_stack.addWidget(self.lag_enemy_page)
...
class MainContainerWindow(QWidget):
    def __init__(self):
        ...
        self.stack.addWidget(self.notice_view)
        self.stack.addWidget(self.keybinds_view)
        self.stack.addWidget(self.expired_view)
...
if __name__ == '__main__':
    try:
        ...
        app_hud = OverlayHUD()
        app_rainbow = RainbowHeaderOverlay()
